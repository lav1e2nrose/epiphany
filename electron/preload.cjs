...
contextBridge.exposeInMainWorld('epiphany', {
  ...
  addAlert: (alert) => ipcRenderer.invoke('store:addAlert', alert),
  updateEventHandling: (eventId, handlingStatus) => ipcRenderer.invoke('store:updateEventHandling', { eventId, handlingStatus }),
  updateAlertHandling: (alertId, handlingStatus) => ipcRenderer.invoke('store:updateAlertHandling', { alertId, handlingStatus }),
  dismissAlert: (alertId) => ipcRenderer.invoke('store:dismissAlert', alertId),
